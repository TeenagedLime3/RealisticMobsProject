package com.teenagedlime3.realisticmobsproject.entity.custom;
...
public class RaccoonEntity extends TamableAnimal implements IAnimatable {
    ...
    protected void registerGoals(){
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.25D, Ingredient.of(Items.APPLE, Items.EGG, Items.BEETROOT_SEEDS, Items.MELON_SEEDS, Items.PUMPKIN_SEEDS, Items.WHEAT_SEEDS),  false));
    ...
    public boolean isFood(ItemStack pStack){
        return pStack.getItem() == Items.APPLE; //for custom item use ItemInit.[item name].get()
    }
    ...
    public InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        Item itemForTaming = Items.APPLE; //item that is used to tame the mob
        Item itemForTaming2 = Items.EGG;
        Item itemForTaming3 = Items.BEETROOT_SEEDS;
        Item itemForTaming4 = Items.MELON_SEEDS;
        Item itemForTaming5 = Items.PUMPKIN_SEEDS;
        Item itemForTaming6 = Items.WHEAT_SEEDS;
        if(isFood(itemstack)) {
            return super.mobInteract(player, hand);
        }

        if ((item == itemForTaming || item == itemForTaming2 || item == itemForTaming3 || item == itemForTaming4 || item == itemForTaming5 || item == itemForTaming6) && !isTame()) {
